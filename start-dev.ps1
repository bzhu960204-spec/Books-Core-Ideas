...
Write-Host ""
Write-Host "=== Books Core Ideas - Dev Start ===" -ForegroundColor Cyan
...
# --- Start backend ---
$backendJob = Start-Job -Name 'bci-backend' -ScriptBlock {
...
# --- Start frontend ---
$frontendJob = Start-Job -Name 'bci-frontend' -ScriptBlock {
